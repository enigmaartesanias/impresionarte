...
const WhatsAppButton = () => {
    ...
    useEffect(() => {
        let defaultMessageText = '¡Hola! Me interesan sus servicios y productos de imprenta.';

        if (location.pathname.includes('/tienda')) {
            defaultMessageText = `Hola, estoy viendo la tienda en: ${window.location.href}. Me gustaría más información sobre sus productos.`;
        } else if (location.pathname === '/contacto') {
            defaultMessageText = 'Hola, quisiera ponerme en contacto con ustedes para una cotización.';
        } else if (location.pathname === '/servicios') {
            defaultMessageText = `Hola, estoy interesado en sus servicios de impresión y diseño gráfico. ¿Podrían asesorarme?`;
        }
